                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="all-orders.php"><i class="mdi-action-view-module"></i>All Orders</a>
                                </li>
								<?php
...
<div id="work-collections" class="seaction">
                    ...
                    $sql = mysqli_query($con, "SELECT * FROM orders WHERE business_id=$business_id AND status LIKE '$status';");
