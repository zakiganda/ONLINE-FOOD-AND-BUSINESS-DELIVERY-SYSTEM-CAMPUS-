    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="admin-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Manage Business</a>
            </li>
              
                 		
            <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Manage Users</a>
            </li>			
        </ul>
...
<table>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><select name="'.$row['id'].'_role">
                      ...
                      <option value="BusinessOwner"'.($row['role']=='BusinessOwner' ? 'selected' : '').'>Business Owner</option>
                    </select></td>';
...
<table>
				...
				<?php
					...
					echo '<td><select name="role">
                      ...
                      <option value="BusinessOwner" selected>BusinessOwner</option>
                    </select></td>';
