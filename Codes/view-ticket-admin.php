        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/rider6.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="rider.php" class="waves-effect waves-cyan"><i class="mdi-maps-directions-bike"></i> Manage Runner</a>
            </li>				
        </ul>
...
<div class="section">
								...
								while($row1 = mysqli_fetch_array($sql1)){
								  ...
								  <li class="collection-item avatar">
									  <i class="'.($role1=='BusinessOwner' ? 'mdi-action-star-rate' : 'mdi-social-person').' cyan circle"></i>
