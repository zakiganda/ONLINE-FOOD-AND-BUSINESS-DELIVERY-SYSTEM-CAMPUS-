    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="business.php" class="waves-effect waves-cyan"><i class="mdi-maps-local-restaurant"></i> Cafe</a>
            </li>
      ...
      <section id="content">
        ...
        <div class="container">
         ...
         <!--  <ul><a href="index.php" /a>Kafe Serumpun</ul>
            <li><a href="index.php" /a>Kafe K10</li>
              <li><a href="index.php" /a>PFC</li> -->
                  ...
                  <div>
                    ...
                    <tbody>
                            ...
                            if(isset($_GET['business_id'])){
                              // Only show the food items of chosen restaurant
                              $_SESSION['business_id'] = $_GET['business_id'];  // used to pass the business Id to check out page.
                              $business_id = $_GET['business_id'];
                              $result = mysqli_query($con, "SELECT * FROM items where not deleted AND business_id = $business_id;");
                              while($row = mysqli_fetch_array($result))
                              {
                               ...
                               // Do not show any food items when customer does not select any restaurant
                            }
