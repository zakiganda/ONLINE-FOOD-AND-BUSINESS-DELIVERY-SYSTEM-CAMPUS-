      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="business.php" class="waves-effect waves-cyan"><i class="mdi-maps-local-restaurant"></i> Cafe</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Review</a>
                            <div class="collapsible-body">
                                <ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">CAFE</h5>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  ...
                  <div>
                    ...
                    <tbody>
                            ...
                            {
                              echo '<tr><td><a href="index.php?business_id='.$row["business_id"].'">'.$row["business_name"].'</td><td>'.$row["business_address"].'</td>';                      
